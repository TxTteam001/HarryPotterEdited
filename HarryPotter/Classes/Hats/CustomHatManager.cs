...
{
    public const string ResourcesDirectory = "HarryPotterHats";
    ...
    internal static string RepositoryUrl
    {
        get
        {
            ...
            return ModHelpers.isCN() ? "https://dl.fangkuai.fun/ModFiles/TheOtherRoles/TheOtherHats" : $"https://raw.githubusercontent.com/{owner}/{repository}/master";
        }
    }
    ...
    {
        Loader = Plugin.Instance.AddComponent<HatsLoader>();
    }
    ...
    {
        var texture = ModHelpers.loadTextureFromDisk(Path.Combine(HatsDirectory, path));
        if (texture == null)
            texture = ModHelpers.loadTextureFromResources(path);
